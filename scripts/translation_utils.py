...
def get_all_strings():
    ...
    regex_data = {
        ...
        r'<[a-zA-Z0-9]+:CheckboxCard' + MAIN_WILDCARD + r'+WarningText=["\'].+["\']' + MAIN_WILDCARD + r'*\/?>': lambda match: match.split(" Text=\"")[1].split("\"")[0].encode('raw_unicode_escape').decode('unicode_escape'),
        ...
        r'<[a-zA-Z0-9]+:SecureCheckboxCard' + MAIN_WILDCARD + r'+WarningText=["\'].+["\']' + MAIN_WILDCARD + r'*\/?>': lambda match: match.split(" Text=\"")[1].split("\"")[0].encode('raw_unicode_escape').decode('unicode_escape'),
