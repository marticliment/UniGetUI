...
try:
    ...
    with open(os.path.join(root_dir, "src/wingetui/Assets/Languages/Translators.json"), "w") as f:
        f.write(json.dumps(langCredits, indent=2, ensure_ascii=False))

    with open(os.path.join(root_dir, "src/wingetui/Assets/Languages/TranslatedPercentages.json"), "w") as f:
