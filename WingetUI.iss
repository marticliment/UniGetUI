...
#define MyAppVersion "3.1.0-alpha2"
...
Source: "src\UniGetUI\bin\x64\Release\net8.0-windows10.0.19041.0\win-x64\publish\choco-cli\*"; DestDir: "{userpf}\..\UniGetUI\Chocolatey"; Flags: createallsubdirs ignoreversion recursesubdirs uninsneveruninstall; Tasks: regularinstall
