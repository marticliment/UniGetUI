...
namespace UniGetUI.Interface
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
        ...
        private class InstalledPackagesPage_obj1_Bindings :
            ...
            IInstalledPackagesPage_Bindings
        {
            private global::UniGetUI.Interface.InstalledPackagesPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = global::WinRT.CastExtensions.As<global::UniGetUI.Interface.InstalledPackagesPage>(newDataRoot);
                    return true;
                }
                return false;
            }
            ...
            {
                global::UniGetUI.Interface.InstalledPackagesPage obj;
            ...
            private bool TryGet_(out global::UniGetUI.Interface.InstalledPackagesPage val)
            {
                val = this.dataRoot;
                return true;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::UniGetUI.Interface.InstalledPackagesPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
            ...
            case 89: // Interface\SoftwarePages\InstalledPackages.xaml line 845
                {
                    ...
                    ((global::UniGetUI.Interface.Widgets.BetterMenuItem)this.MenuRemoveData).Click += this.MenuRemoveData_Invoked;
                }
                break;
            case 90: // Interface\SoftwarePages\InstalledPackages.xaml line 850
                {
                    this.MenuReinstall = global::WinRT.CastExtensions.As<global::UniGetUI.Interface.Widgets.BetterMenuItem>(target);
                    ((global::UniGetUI.Interface.Widgets.BetterMenuItem)this.MenuReinstall).Click += this.MenuReinstall_Invoked;
                }
                break;
            case 91: // Interface\SoftwarePages\InstalledPackages.xaml line 854
                {
                    this.MenuUninstallThenReinstall = global::WinRT.CastExtensions.As<global::UniGetUI.Interface.Widgets.BetterMenuItem>(target);
                    ((global::UniGetUI.Interface.Widgets.BetterMenuItem)this.MenuUninstallThenReinstall).Click += this.MenuUninstallThenReinstall_Invoked;
                }
                break;
