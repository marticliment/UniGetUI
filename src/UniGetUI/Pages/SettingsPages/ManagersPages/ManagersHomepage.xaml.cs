    ...
    public sealed partial class ManagersHomepage : Page, ISettingsPage
    {
        ...
        public ManagersHomepage()
        {
            ...
            foreach(var manager in PEInterface.Managers)
            {
                ...
                toggle.Toggled += (_, _) => Settings.SetDictionaryItem(Settings.DisabledManagers, manager.Name, !toggle.IsOn);
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            for(int i = 0; i < managerControls.Count; i++)
            {
                ...
                toggle.IsOn = !Settings.GetDictionaryItem<string, bool>(Settings.DisabledManagers, PEInterface.Managers[i].Name);
            }
