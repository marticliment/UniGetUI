...
namespace UniGetUI.Interface
{
    public abstract partial class AbstractPackagesPage : IKeyboardShortcutListener, IEnterLeaveListener
    {
        ...
        protected AbstractPackagesPage(PackagesPageData data)
        {
            ...
            int viewMode = Settings.GetDictionaryItem<string, int>(Settings.PackageListViewMode, PAGE_NAME);
            ...
            InstantSearchCheckbox.IsChecked = !Settings.GetDictionaryItem<string, bool>(Settings.DisableInstantSearch, PAGE_NAME);
        ...
        private void InstantSearchValueChanged(object sender, RoutedEventArgs e)
            => Settings.SetDictionaryItem(Settings.DisableInstantSearch, PAGE_NAME, !InstantSearchCheckbox.IsChecked);
        ...
        private void SidepanelWidth_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            {
                HideFilteringPane();
                Settings.SetDictionaryItem(Settings.SidepanelWidths, PAGE_NAME, 250);
            }
            else
            {
                Settings.SetDictionaryItem(Settings.SidepanelWidths, PAGE_NAME, (int)e.NewSize.Width);
            }
        }
        ...
        private void ToggleFiltersButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Settings.SetDictionaryItem(Settings.HideToggleFilters, PAGE_NAME, !ToggleFiltersButton.IsChecked ?? false);
            }
        ...
        private void ShowFilteringPane()
        {
            if (FilteringPanel.DisplayMode is SplitViewDisplayMode.Inline)
            {
                ...
                try
                {
                    finalWidth = Settings.GetDictionaryItem<string, int>(Settings.SidepanelWidths, PAGE_NAME);
                }
                catch
                {
                    Settings.SetDictionaryItem(Settings.SidepanelWidths, PAGE_NAME, 250);
        ...
        private void SetFilterMode_Inline()
        {
            ...
            if (!Settings.GetDictionaryItem<string, bool>(Settings.HideToggleFilters, PAGE_NAME))
            {
                ShowFilteringPane();
            }
        }
        ...
        {
            Settings.SetDictionaryItem(Settings.PackageListViewMode, PAGE_NAME, ViewModeSelector.SelectedIndex);
        }
