...
public class DWMThreadHelper
{
    ...
    public static void ChangeState_DWM(bool suspend)
    {
        ...
        DWMThreadAdress ??= GetTargetFunctionAddress("dwmcorei.dll", 0x32380);// 0x36170);
    ...
    public static void ChangeState_XAML(bool suspend)
    {
        ...
        XAMLThreadAdress ??= GetTargetFunctionAddress("Microsoft.UI.Xaml.dll", 0x27A6F0);//0x2771A0);
