...
namespace UniGetUI.Core.Data
{
    public static class CoreData
    {
        ...
        public const string VersionName = "3.3.5"; // Do not modify this line, use file scripts/apply_versions.py
        public const int BuildNumber = 103; // Do not modify this line, use file scripts/apply_versions.py
