...
namespace UniGetUI.Core.Data
{
    public static class CoreData
    {
        ...
        public const string VersionName =  "3.1.2"; // Do not modify this line, use file scripts/apply_versions.py
        public const double VersionNumber =  3.12; // Do not modify this line, use file scripts/apply_versions.py
