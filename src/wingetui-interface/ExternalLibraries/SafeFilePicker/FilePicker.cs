...
public class FilePicker
{
    ...
    public FilePicker(IntPtr windowHandle)
    {
...
public class FileSavePicker
{
    ...
    /// <param name="typeFilters">List of extensions applied on dialog.</param>
    /// <returns>Path to selected file or empty string.</returns>
    public string Show(List<string>? typeFilters = null, string name = null)
    {
        return Helper.ShowSave(_windowHandle, FOS.FOS_FORCEFILESYSTEM, typeFilters, name);
    }
}
