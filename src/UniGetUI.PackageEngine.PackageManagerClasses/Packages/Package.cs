...
namespace UniGetUI.PackageEngine.PackageClasses
{
    public class Package : IPackage
    {
        ...
        private Uri? LoadIconUrlIfAny()
        {
            try
            {
                CacheableIcon? icon = TaskRecycler<CacheableIcon?>.RunOrAttach(Manager.PackageDetailsProvider.GetPackageIconUrl, this);
        ...
        {
            return Manager.PackageDetailsProvider.GetPackageScreenshotsUrl(this);
        }
