...
public abstract class PackagePkgOperationHelper<ManagerT> : IPackageOperationHelper where ManagerT : IPackageManager
{
    protected ManagerT Manager;

    public PackagePkgOperationHelper(ManagerT manager)
    {
        Manager = manager;
    }
