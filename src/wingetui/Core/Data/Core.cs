...
namespace ModernWindow.Core.Data
{
    ...
    {
        public static string VersionName =  "3.0.2"; // Do not modify this line, use file scripts/apply_versions.py
        public static double VersionNumber =  3.02; // Do not modify this line, use file scripts/apply_versions.py
