...
try:
    ...
    from wingetui.Interface.BackendApi import runBackendApi
    ...
    from wingetui.Interface.Application import WingetUIApplication
    ...
    import traceback
    import webbrowser
    if "langName" not in _globals() and "langName" not in locals():
        langName = "Unknown"
    try:
