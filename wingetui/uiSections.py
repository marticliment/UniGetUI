...
class SettingsSection(QScrollArea):
    ...
    def scoopAddExtraBucket(self) -> None:
        ...
        if r[1]:
            print(r[0])
            globals.installersWidget.addItem(PackageInstallerWidget(f"{r[0]} Scoop bucket", "custom", customCommand=f"{scoopHelpers.scoop} bucket add {r[0]}"))
    ...
    def scoopRemoveExtraBucket(self) -> None:
        ...
        if r[1]:
            print(r[0])
            globals.installersWidget.addItem(PackageUninstallerWidget(f"{r[0]} Scoop bucket", "custom", customCommand=f"{scoopHelpers.scoop} bucket rm {r[0]}"))
